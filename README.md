...
Algunas funcionalidades que se podrían agregar:

### Funcionalidades de Usuario
- [ ] Registro de nuevos usuarios  
- [ ] Perfiles de usuario personalizables
- [ ] Compartir archivos con otros usuarios
- [ ] Links de descarga públicos con expiración
...
Este proyecto fue desarrollado como prueba técnica, pero está abierto a mejoras y contribuciones. Si encuentras bugs o tienes sugerencias, no dudes en crear un issue o pull request.

**Desarrollado con ❤️ usando Docker, FastAPI y SvelteKit**
